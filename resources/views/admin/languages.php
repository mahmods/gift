<?php
	...
	if ($action == "add") {
		echo notices().'<form action="" method="post" class="form-horizontal single">
				'.csrf_field().'
				<h5><a href="languages"><i class="icon-arrow-left"></i></a>Add new Language</h5>
					<fieldset>
	...
	elseif($action == "edit")
	{
		echo notices().'<form action="" method="post" class="form-horizontal single">
				'.csrf_field().'
				<h5><a href="languages"><i class="icon-arrow-left"></i></a>Edit Language</h5>
					<fieldset>
						  <div class="form-group">
							<label class="control-label">Language</label>
	...
	?>
<div class="head">
	<h3>Languages<a href="languages/add" class="add">Add language</a></h3>
...
<h4>Available languages :</h4>
	<?php
		...
		foreach ($langs as $lang){
			echo '<div class="bloc">
				<h5>
					<a href="languages?language='.$lang->code.'">'.$lang->name.'</a>
					<div class="tools">
						<a href="languages/delete_language/'.$lang->id.'"><i class="icon-trash"></i></a>
						<a href="languages/edit/'.$lang->id.'"><i class="icon-pencil"></i></a>
					</div>
				</h5>
			</div>';
		}
		...
		foreach ($translations as $translation){
			echo'<div class="bloc" style="padding: 0px;">
				<div class="col-md-6" style="padding: 22px 25px;"><b>'.htmlspecialchars($translation->word).'</b><div class="tools"><a href="languages/delete/'.$translation->id.'?language='.$l.'"><i class="icon-trash"></i></a></div></div>
	...
	<script>
		$('.translate').click(function(){
			...
			$.post('languages/save/'+data,{translation: translation,_token: '<?=csrf_token()?>'},function(d){
				alert('Saved');
			});
		});
	</script>
