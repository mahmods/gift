...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
		...
		(NULL, 'en', 'Gift', 'Gift'),
		(NULL, 'en', 'Language', 'Language'),
		(NULL, 'en', 'Arabic', 'Arabic'),
		(NULL, 'en', 'English', 'English'),
		(NULL, 'en', 'Search for...', 'Search for...'),
		(NULL, 'en', 'Search', 'Search'),
		(NULL, 'en', 'Account', 'Account'),
		(NULL, 'en', 'Register', 'Register'),
		(NULL, 'en', 'Login', 'Login'),
		(NULL, 'en', 'Cart', 'Cart'),
		(NULL, 'en', 'Home', 'Home'),
		(NULL, 'en', 'Men', 'Men'),
		(NULL, 'en', 'Women', 'Women'),
		(NULL, 'en', 'kids', 'kids'),
		(NULL, 'en', 'About us', 'About us'),
		(NULL, 'en', 'FAQ', 'FAQ'),
		(NULL, 'en', '404', '404'),
		(NULL, 'en', 'Support', 'Support'),
		(NULL, 'en', 'Find the perfect gift', 'Find the perfect gift'),
		(NULL, 'en', 'Menu', 'Menu'),
		(NULL, 'en', 'Products', 'Products'),
		(NULL, 'en', 'Blog', 'Blog'),
		(NULL, 'en', 'Payment methods', 'Payment methods'),
		(NULL, 'en', 'copyright_text', 'All Rights Reserved.'),
		(NULL, 'en', 'Shop now', 'Shop now'),
		(NULL, 'en', 'Have a coupon code ?', 'Have a coupon code ?'),
		(NULL, 'en', 'Coupon code', 'Coupon code'),
		(NULL, 'en', 'Apply', 'Apply'),
		(NULL, 'en', 'Categories', 'Categories'),
		(NULL, 'ar', 'Gift', 'هدية'),
		(NULL, 'ar', 'Language', 'اللغة'),
		(NULL, 'ar', 'Arabic', 'العربية'),
		(NULL, 'ar', 'English', 'الانجليزية'),
		(NULL, 'ar', 'Search for...', 'بحث عن ...'),
		(NULL, 'ar', 'Search', 'بحث'),
		(NULL, 'ar', 'Account', 'الملف الشخصي'),
		(NULL, 'ar', 'Register', 'تسجيل'),
		(NULL, 'ar', 'Login', 'تسجيل الدخول'),
		(NULL, 'ar', 'Cart', 'سلة التسوق'),
		(NULL, 'ar', 'Home', 'الرئيسية'),
		(NULL, 'ar', 'Men', 'ملابس رجالية'),
		(NULL, 'ar', 'Women', 'ملابس نسائية'),
		(NULL, 'ar', 'kids', 'ملابس أطفال'),
		(NULL, 'ar', 'About us', 'من نحن'),
		(NULL, 'ar', 'FAQ', 'FAQ'),
		(NULL, 'ar', '404', '404'),
		(NULL, 'ar', 'Support', 'الدعم'),
		(NULL, 'ar', 'Find the perfect gift', 'اعثر على الهدية المثالية'),
		(NULL, 'ar', 'Menu', 'القائمة'),
		(NULL, 'ar', 'Products', 'المنتجات'),
		(NULL, 'ar', 'Blog', 'المدونة'),
		(NULL, 'ar', 'Payment methods', 'طرق الدفع'),
		(NULL, 'ar', 'copyright_text', 'جميع الحقوق محفوظة لــ هديتك.كوم'),
		(NULL, 'ar', 'Shop now', 'تسوق الآن'),
		(NULL, 'ar', 'Have a coupon code ?', 'لديك كوبون خصم ؟'),
		(NULL, 'ar', 'Coupon code', 'كوبون خصم'),
		(NULL, 'ar', 'Apply', 'تطبيق'),
		(NULL, 'ar', 'Categories', 'التصنيفات');"
