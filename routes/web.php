...
Route::get('/account/address', 'Frontend@address')->middleware('Customer');
...
Route::get('/cart', 'Frontend@cart')->middleware('Customer');;
Route::match(['get', 'post'],'/checkout/{step?}', 'Frontend@checkout')->middleware('Customer');
