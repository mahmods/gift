<?php 
/*
	We are using the cookies variable because the request helper didn't work inside the functions , if you have a workaround for this please send us an email at support@miniapps.design
