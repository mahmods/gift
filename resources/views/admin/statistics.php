<?php echo $header?>
<div class="head">
	<h3>Statistics<a href="statistics" class="add">Week</a><a href="statistics/month" class="add">Month</a><a href="statistics/year" class="add">Year</a></h3>
	<p>Expanded Statistics of your website in this <?=$term?></p>
</div>
<div class="single">
	<div class="col-lg-<?php echo $term == 'year'?'12':'3';?> s">
		<div class="stats">
			<div class="shead">
				<h5><i class="icon-list"></i> Orders<label><?php echo $orders?></label></h5>
			</div>
			<canvas id="orders" width="100" height="<?php echo $term == 'year'?'30':'60';?>"></canvas>
			<div class="foot">
	...
	<div class="col-lg-<?php echo $term == 'year'?'12':'3';?> s">
		<div class="stats">
			...
			<canvas id="visitors" width="100" height="<?php echo $term == 'year'?'30':'60';?>"></canvas>
			<div class="foot">
	...
	<div class="col-lg-<?php echo $term == 'year'?'12':'3';?> s">
		<div class="stats">
			...
			<canvas id="sales" width="100" height="<?php echo $term == 'year'?'30':'60';?>"></canvas>
			<div class="foot">
	...
	<div class="col-lg-<?php echo $term == 'year'?'12':'3';?> s">
		<div class="stats">
			...
			<canvas id="conversion" width="100" height="<?php echo $term == 'year'?'30':'60';?>"></canvas>
			<div class="foot">
